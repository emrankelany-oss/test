...
/**
 * V20Preloader — "Monogram Assembly → Cinemascope Split"
 *
...
export default function V20Preloader() {
  ...
  useEffect(() => {
    ...
    const page = document.querySelector(".v20-page");
  ...
  return (
    ...
    >
      ...
      <div ref={topRef} className="v20pl-panel v20pl-panel--top" aria-hidden="true" />
      <div ref={botRef} className="v20pl-panel v20pl-panel--bot" aria-hidden="true" />

      {/* tinted prism glow — depth layer behind the monogram */}
      <div ref={glowRef} className="v20pl-glow" aria-hidden="true" />

      {/* hairline seam along the split line */}
      <div ref={seamRef} className="v20pl-seam" aria-hidden="true" />

      {/* centred core: monogram, wordmark, counter — fades out at the burst */}
      <div ref={coreRef} className="v20pl-core">
        <svg
          className="v20pl-mark"
          viewBox="0 0 120 120"
          width="120"
          height="120"
          aria-hidden="true"
        ...
        <div ref={wordRef} className="v20pl-word" aria-hidden="true">
          The Motion Agency
        </div>

        <div ref={metaRef} className="v20pl-meta" aria-hidden="true">
          <span className="v20pl-bar">
            <span ref={barRef} className="v20pl-bar-fill" />
          </span>
          <span ref={counterRef} className="v20pl-count">00</span>
        </div>
      </div>
    </div>
  );
