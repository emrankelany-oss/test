...
/**
 * V21Preloader — "Monogram Assembly → Cinemascope Split"
 *
...
export default function V21Preloader() {
  ...
  useEffect(() => {
    ...
    const page = document.querySelector(".v21-page");
  ...
  return (
    ...
    >
      ...
      <div ref={topRef} className="v21pl-panel v21pl-panel--top" aria-hidden="true" />
      <div ref={botRef} className="v21pl-panel v21pl-panel--bot" aria-hidden="true" />

      {/* tinted prism glow — depth layer behind the monogram */}
      <div ref={glowRef} className="v21pl-glow" aria-hidden="true" />

      {/* hairline seam along the split line */}
      <div ref={seamRef} className="v21pl-seam" aria-hidden="true" />

      {/* centred core: monogram, wordmark, counter — fades out at the burst */}
      <div ref={coreRef} className="v21pl-core">
        <svg
          className="v21pl-mark"
          viewBox="0 0 120 120"
          width="120"
          height="120"
          aria-hidden="true"
        ...
        <div ref={wordRef} className="v21pl-word" aria-hidden="true">
          The Motion Agency
        </div>

        <div ref={metaRef} className="v21pl-meta" aria-hidden="true">
          <span className="v21pl-bar">
            <span ref={barRef} className="v21pl-bar-fill" />
          </span>
          <span ref={counterRef} className="v21pl-count">00</span>
        </div>
      </div>
    </div>
  );
