 ...
 *
 * Mounted at the WORK-LANE level (before <V21Filament/>) as a viewport-fixed
 ...
 */
export default function V21FlowField() {
  ...
  if (reduced) {
    return <div ref={elRef} className="v21-mm-flow v21-mm-flow--static" aria-hidden="true" />;
  }
  return <canvas ref={elRef} className="v21-mm-flow" aria-hidden="true" />;
}
